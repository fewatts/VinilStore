package com.generation.vinylstore.controller;
...
import com.generation.vinylstore.repository.*;
...
public class CategoriasController {
    ...
    @GetMapping("/filtro/{categorias}")
    public ResponseEntity<List<Categorias>> getByTitle(@PathVariable String categorias){
        return ResponseEntity.ok(categoriasRepository.findAllByCategoriasContainingIgnoreCase(categorias));
    }
    @PostMapping
